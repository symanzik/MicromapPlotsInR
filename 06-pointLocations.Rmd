...
circles_sf <- st_buffer(points_sf,dist = 400000, nQuadSegs = 4)
...
stadium_circles <- st_buffer(stadiums, dist = 40000, nQuadSegs = 4)
```
...
Walk through jittering the stadium locations and make a better, final map
