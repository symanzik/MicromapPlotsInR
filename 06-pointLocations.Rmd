...
```{r fig.cap="Circles drawn around thelocations of county seats. No that overlap between individual circles is fairly limited, because some locations have been adjusted."}
...
We can extract anbasemap of the UK, and crop it to the extent we are 
interested. 
