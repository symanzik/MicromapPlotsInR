...
### Creating a Basic Linked Micromap Plot {#Ch6-Example1-Micromap}
...
As this is not the case, we have to adjust one of them.
...
### Creating Initial Linked Micromap Plot {#Ch6-Example3-Creating}
