...
```{r Ch6-MicromapSeat-error, fig.cap = "Micromap showing the elevations and population at the last Census of county seats in Utah. Some locations have been adjusted to decrease overplotting.", fig.width = 5, fig.height = 7}
mmplot(
  stat.data = seats_df,
  map.data = seat_map_df,
  panel.types = c("map", "dot_legend", "labels", "dot"),
  panel.data = list(NA, NA, "county_seat", "elevation"),
  map.link = c("county_seat", "ID"),
  ord.by = "elevation",
  grouping = c(5, 5, 4, 4, 5, 5),
  median.row = TRUE,
