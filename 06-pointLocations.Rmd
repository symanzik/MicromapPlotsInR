...
\begin{enumerate}
  ...
  to display.
  \item If needed, adjust the locations of points that are close to each other. Otherwise, if points are very close together they may almost entirely overlap on the final map,
