...
fig2 <- ggdraw() +
  draw_image(paste0(output_dir_US, "/USst_FP_Final_areaVisBorders2pt5pct.png"),
    scale = scaling
  )
fig3 <- ggdraw() +
...
The state of Kentucky's website provides the ADD name for each county [@KCADDnd]. The U.S. 2000 Census Bureau County boundary data for Kentucky provides the boundaries and the shapefile provides the county ID (“COUNTY”) and name (“NAME”).
