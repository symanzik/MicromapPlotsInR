...
BuildBorderGroup(
  ...
  debug = 512 + 128 # generate 4 intermediate PNG map plots
)
```

```{r Ch4b-BuildBorderGroupUS-pdf, echo = FALSE, results = 'hide'}
...
BuildBorderGroup(
  ...
  IDHdr = "States", # 1 of 2 header lines for ID Glyph column (Max 12 chars)
  ReducePC = 0.2, # reduce vertices to 0.2% of original number
  debug = 512 + 0 # generate 4 intermediate PDF map plots
)
```
