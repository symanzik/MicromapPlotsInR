...
pdf("data/Ch4b/Ky_ADD_SPDF.pdf", width = 4, height = 2)
par(mar = c(0, 0, 0, 0))
plot(KY_ADD_SPDF)
dev.off()

png("data/Ch4b/KY_ADD_SPDF.png", width = 4, height = 2, units = "in", res = 300)
par(mar = c(0, 0, 0, 0))
plot(KY_ADD_SPDF)
dev.off()

pdf("data/Ch4b/Ky_shp.pdf", width = 4, height = 2)
par(mar = c(0, 0, 0, 0))
plot(KY_shp)
dev.off()

png("data/Ch4b/KY_shp.png", width = 4, height = 2, units = "in", res = 300)
par(mar = c(0, 0, 0, 0))
plot(KY_shp)
dev.off()
...
par(mar = c(0, 0, 0, 0))
knitr::include_graphics(c(
  "data/Ch4b/KY_shp.png",
  "data/Ch4b/KY_ADD_SPDF.png"
),
auto_pdf = TRUE
)
```
