...
in geographic space." In contrast, traditionally used choropleth maps emphasize
the map visualization and put less emphasis on the visualization of the statistical data.
According to @PoLa2018, a choropleth map is a "map in which regions with differing occurrence rates 
...
where such a subregion is enlarged and sometimes also gets pulled to the outside of the main map area.
...
from highest (on top) to lowest (at the bottom) according to `StatVar4`.
This layout also makes use of a median row and places the maps on the right.
