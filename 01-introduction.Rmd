...
is ideal from a cognitive perspective. However, sometimes it is desireable to highlight
...
that contain a `1` should be interpreted as partitionings with a median row.
