...
Anthony R. Olsen and Susanne M. Pierson from the Environmental Protection Agency in Corvallis, Oregon.
Linda W. Pickle and B. Sue Bell from the National Cancer Institute and others
soon developed an interest in the use of interactive linked micromap plots\index{Linked micromap plot}
for cancer data [@CCBPZ2002;@CBPZL2003].
