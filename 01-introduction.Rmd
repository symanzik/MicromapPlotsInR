...
In particular, the values for `StatVar4` originate from a Normal distribution with 
...
```{r Ch1-NJ-Layout3, fig.cap = 'Mock-up linked micromap plot\\index{Linked micromap plot}, based on the 21 counties of New Jersey. `StatVar4` is used as the sorting variable.', fig.width = 7, fig.height = 6, echo = FALSE}
# create linked micromap plot
mmplot(
  stat.data = nj_data,
  map.data = nj_polys_table,
...
with `StatVar4`. This becomes most obvious in Figure \@ref(fig:Ch1-NJ-Layout3).
