...
Figures \@ref(fig:Ch1-NJ-Layout1) and \@ref(fig:Ch1-NJ-Layout2) show six-column
linked micromap plots\index{Linked micromap plot} for the 21 counties of New Jersey.
...
about `r round(cor(nj_data$StatVar2, nj_data$StatVar3), digits = 2)`


```{r Ch1-NJ-Layout2, fig.cap = 'Mock-up linked micromap plot\\index{Linked micromap plot}, based on the 21 counties of New Jersey. Main changes are the use of two-ended cumulative maps, the reduced number of perceptual groups, the introduction of a median row, and using _StatVar2_ as the sorting variable.', fig.width = 7, fig.height = 8, echo = FALSE}
# create linked micromap plot
mmplot(
  stat.data = nj_data,
  map.data = nj_polys_table,
