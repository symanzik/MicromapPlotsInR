...
```{r Ch3-micromap1, fig.cap = 'Prevalence of covid-19 cases by U.S. state on Jan. 19, 2021', fig.width = 7, fig.height = 9}
...
head(STcovidcaserates)
panelDesc = data.frame(
  type=c('map','id','dot'),  
  lab1=c('','','Cases/100,000'),		
  col1=c(NA,NA,'Jan_19_2021')
 )


# default = alphabetic state name sort
micromapST(STcovidcaserates,panelDesc,
            title=c('US State Covid Case Rates, Jan. 19, 2021'))  
```

- text about sorting to bring out geographic patterns
- reuse last paneldesc
- sort by case rate

```{r Ch3-micromap2, fig.cap = 'Prevalence of covid-19 cases by U.S. state on Jan. 19, 2021', fig.width = 7, fig.height = 9}
micromapST(STcovidcaserates,panelDesc,
            sortVar='Jan_19_2021',ascend=F,
            title=c('US State Covid Case Rates, Jan. 19, 2021'))  
```
...
```{r Ch3-micromap3, fig.cap = 'Prevalence of covid-19 cases by U.S. state on 11/9/2020, as measured by the percentage of residents who knew someone with covid', fig.width = 7, fig.height = 9}
