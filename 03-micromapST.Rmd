...
Since the default grouping led to a fairly clear clustering of counties within Maryland, this revised grouping (Figure \@ref(fig:Ch3-LMMMDpercep)) is only slightly better. 
