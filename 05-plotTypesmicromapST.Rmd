...
```{r Ch5b-micromap5, fig.cap = 'Scatter plot of percent of residents with income < 150% federal poverty level and percent with 4+ years of college, sorted by percent who attended college 4+ years. A LOWESS smoothing line has been overlaid.', fig.width = 7, fig.height = 9}
library(micromapST)
