...
temp_dates <- c(
  20.125, 20.218, 20.288, 20.375, 20.458, 20.541,
...
### Shorter R code without loops - please check
...
temp_array3[, , 1] <- rep(temp_dates, each = 51)
temp_array3[, , 2] <- sapply(temp_rates, as.numeric)

temp_array3[1:3, 1:8, ]

all(temp_array2 == temp_array3)
```
