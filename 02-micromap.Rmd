...
While most of the linked micromap plots\index{Linked micromap plot} 
...
Additional details and examples for both options can also be found in the
vignette [@PBWMOK2024Vignette] of the **micromap**\index{R Packages!micromap} R package.
