...
the largest observed median specific conductance on top, 
...
that are the population estimates of the specific conductance values,
...
There is a weak spatial pattern with the highest median observed specific conductance values in the northern and 
western subbasins of West Virginia. There is a notable spatial cluster in the 
central-eastern subbasins of West Virginia with the five lowest median observed specific conductance values
...
the widths of the confidence bounds and the estimated specific conductance values. The higher the 
...
Here, some extreme outliers dominate, e.g., observed specific conductance values of about 5,000 $\mu$S/cm
