...
wv.data.ds1$alt.name <- as.factor(wv.data.ds1$Random_Wat)
...
lmplot(
  ...
  median.row = FALSE,
#  plot.height = 9, 
#  plot.width = 6.8, # for poster use plot.height=6, plot.width=9,
  ...
  panel.att = list(
    ...
    list(
      ...
      xaxis.title = "Conductivity (x1000)", 
