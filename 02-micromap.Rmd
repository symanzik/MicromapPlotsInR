...
and a dot plot with confidence bounds\index{Dot plot with confidence bounds}
...
shows dot plots with confidence bounds\index{Dot plot with confidence bounds} 
...
## Discussion and Further Reading {#Ch2-FurtherReading}
...
in addition to dot plots\index{Dot plot},
