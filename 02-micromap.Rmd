...
```{r Ch2-creatingdraftWVdotsf, fig.cap = 'Draft linked micromap plot\\index{Linked micromap plot}, based on the `wv_data` data frame. In contrast to the previous figure, this version has been created directly from the external shapefiles without using the `create_map_table()` function first.', fig.width = 7, fig.height = 7}
...
par(mar = c(0, 0, 0, 0))
plot(st_geometry(wv_watershed_sf))
