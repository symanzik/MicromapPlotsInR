...
but with the fourth highest percentage living below poverty level (more than 18%).
As expected, the overall correlation between these two variables is negative,
but given these outliers, the correlation coefficient $r$ is 
