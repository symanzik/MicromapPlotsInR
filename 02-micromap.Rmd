...
section and refine it in multiple small steps. This refinement should only be started once
...
stored in simple features\index{Simple features} (sf) format [@OGC2022] instead of
SpatialPolygonsDataFrame\index{SpatialPolygonsDataFrame}
...
statistical columns of the linked micromap plot\index{Linked micromap plot}.
