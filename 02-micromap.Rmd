...
For functions from the other packages, an additional transformation step would be needed.
...
Even though we want to ultimately display boxplots and dot plots with confidence bounds in the
statistical graphics columns of the linked micromap plot,\index{Linked micromap plot}
...
for the third and fourth column. No further data has to be used for the
