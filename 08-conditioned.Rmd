...
```{r Ch8-CCmap1NCmod1, fig.cap = 'First modified trivial 1-dimensional conditioned choropleth maps example based on the CCmaps() function from the maptools R package.', fig.width = 7, fig.height = 4}
...
```{r Ch8-CCmap1NCmod2, fig.cap = 'Second modified trivial 1-dimensional conditioned choropleth maps example based on the CCmaps() function from the maptools R package.', fig.width = 7, fig.height = 4}
# modified 2
...
## WV Examples from Brent Mast {#Ch8-Examples-WV}
...
## WV Conditioned Choropleth Maps with Factors {#Ch8-Factors-WV}


```{r Ch8-ccmap-cat1, fig.cap = 'Conditioned choropleth map 1 for 1 categorical variable.', fig.width = 7, fig.height = 4}
...
```{r Ch8-ccmap-cat3, fig.cap = 'Conditioned choropleth map 3 for 1 quantitative and 1 categorical variable (order switched).', fig.width = 7, fig.height = 5}
myCCmaps(
  obj = wv,
  # Note that COI variable does not exist in local data set; use z_COI_nat instead
  # zcol = "COI",
...
```{r Ch8-ccmap-cat5, fig.cap = 'Conditioned choropleth map 5 for 2 categorical variables (with more than 2 factor levels).', fig.width = 7, fig.height = 4.5}
pop_growth3 <- factor(
...
```{r Ch8-ccmap-cat6, fig.cap = 'Conditioned choropleth map 6 for 2 categorical variables (with more than 2 factor levels). Also with externally provided text information.', fig.width = 7, fig.height = 4.5}
xlim <- sp::bbox(wv)[1, ]
ylim <- sp::bbox(wv)[2, ]
...
## DC Examples from Brent Mast {#Ch8-Examples-DC}


```{r Ch8-ccmap3, fig.cap = 'Conditioned choropleth map 3.', fig.width = 7, fig.height = 6}
...
```{r Ch8-ccmap3mod, fig.cap = 'Modified conditioned choropleth map 3.', fig.width = 7, fig.height = 6}
# modified
...
```{r Ch8-ccmap8, fig.cap = 'Conditioned choropleth map 8.', fig.width = 7, fig.height = 6}
...
```{r Ch8-ccmap8mod, fig.cap = 'Modified conditioned choropleth map 8.', fig.width = 5, fig.height = 6}
# modified
...
## NJ Examples from Brent Mast {#Ch8-Examples-NJ}
...
```{r Ch8-ccmap6, fig.cap = 'Conditioned choropleth map 6.', fig.width = 7, fig.height = 8}
# Original file: NJ_Counties4.R
# Original output: NJ_Two_Way_CCMap.jpeg
# Original data: nj_cnty_disab_gaps.csv & nj_mi2.Rdata
...
# Code for "NJ_Two_Way_CCMap.jpeg"
myCCmaps(
  obj = nj2,
  zcol = "abs_gap_math",
  cvar = list(
...
```{r Ch8-ccmap6mod, fig.cap = 'Modified conditioned choropleth map 6.', fig.width = 7, fig.height = 8}
# modified
...
```{r Ch8-ccmap7, fig.cap = 'Conditioned choropleth map 7.', fig.width = 7, fig.height = 8}
# Original file: NJ_Counties4.R
...
```{r Ch8-ccmap7mod, fig.cap = 'Modified conditioned choropleth map 7.', fig.width = 7, fig.height = 8}
# modified
