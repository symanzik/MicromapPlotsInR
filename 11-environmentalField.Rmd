...
```{r, Ch11-micromap-spsurvey-correct, eval = TRUE, echo = FALSE, fig.show = 'hold', fig.cap = 'Oregon Lakes Sample Frame & Equal Probability Sites in Projected Coordinates'}
