...
```{r Ch11-micromapVDEQ2, eval = FALSE}
#
```
...
```{r Ch11-micromapFDEP2, eval = FALSE}
#
```
...
```{r Ch11-micromap-spsurvey-correct, eval = TRUE, echo = FALSE,  fig.cap = 'Oregon Lakes Sample Frame & Equal Probability Sites in Projected Coordinates'}
