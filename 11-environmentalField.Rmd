...
\chapterauthor{Marcus W. Beck, Michael McManus, J{\"u}rgen Symanzik}


This chapter will focus on micromap applications from the environmental field. 
Components from several of the previous chapters are revisited here, e.g., 
how to include non-standard geographic boundaries, e.g., watersheds, ecoregions, 
and climate zones, and deal with non-standard graph types 
such as arrow plots to visualize changes over time.
