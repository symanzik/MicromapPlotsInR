...
```{r Ch5-vignettechart1, fig.cap = 'Arrow plot 1 from vignette.', fig.width = 7, fig.height = 9}
mmplot(
  stat.data = myStats,
  map.data = statePolys,
...
```{r Ch5-vignettechart2, fig.cap = 'Arrow plot 2 from vignette.', fig.width = 7, fig.height = 9}
data(lungMort)
myStats <- lungMort
...
```{r Ch5-barchartArgentina-setup1}
...
```{r Ch5-barchartArgentina-setup2}
myPanelAtts <- standard_att()
...
```{r Ch5-scatterplot1, fig.cap = 'Scatterplot 1.', fig.width = 7, fig.height = 9}
...
```{r Ch5-scatterplot2, fig.cap = 'Scatterplot 2.', fig.width = 7, fig.height = 9}
...
```{r Ch5-scatterplot3, fig.cap = 'Scatterplot 3.', fig.width = 7, fig.height = 9}
### ======================================================================== ###
